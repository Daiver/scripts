...
void Tracker::initPoints(cv::Mat& gray, std::vector<cv::Point2f>& points, const int MAX_COUNT)
{
...
std::vector<cv::Point2f> Tracker::track(cv::Mat& gray, bool* is_good)
{
    this->initPoints(gray, this->points[1], this->MAX_COUNT);
