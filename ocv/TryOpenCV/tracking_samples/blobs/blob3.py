        ...
        while True:
            ...
            if len(points):
                ...
                if self.mode == 227:
                    ...
                    '''if points:
                        old = (self.workrect[0] + (self.workrect[2] - self.workrect[0])/2, self.workrect[1] + (self.workrect[3] - self.workrect[1])/2 )
                        ppt = min(points,key=lambda x: (x[0]-old[0])**2 + (x[1] - old[1])**2)'''
