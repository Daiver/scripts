...
class videowork:
    ...
    def __init__(self):
        ...
        self.pt1 = (320, 80)
        self.pt2 = (447, 250)
        self.oldcenter = self.GetCenter()
        self.additionslds = ClassificationDataSet(self.ninsize[0] * self.ninsize[1], nb_classes=2)
        self.key = -1
        self.detector = LKDetector(5, 5)
        f = open('WorkingNNs/l22bak_25_25_rprop_100_p', 'r')
        #f = open('WorkingNNs/l21bak_25_25_rprop_very_well', 'r')
    ...
    def GetCenter(self):
        return (self.pt1[0] + (self.pt2[0] - self.pt1[0])//2, self.pt1[1] + (self.pt2[1] - self.pt1[1])//2)
    ...
    def work(self, image):
        ...
        self.detect_state = out = self.ClassifyWindow(grayscale, currentrect)
    ...
    def run(self):    
        ...
        while k !='q' :
            ...
            if self.ctrl_mouse and self.detect_state == 1:
                self.move_mouse(self.GetCenter())
